  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-indigo-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-8">TemplateHub API Status</h1>
        
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="flex justify-between items-center">
              <span>System Status</span>
              <Badge variant={allOperational ? "default" : "destructive"} className="text-sm">
            ...
            <Card key={service.name}>
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center">
                  <Badge variant="outline" className={`${statusColors[service.status]} text-white`}>
                    {service.status.charAt(0).toUpperCase() + service.status.slice(1)}
                  </Badge>
                  <span className="text-xs text-gray-500">Updated {service.lastUpdated}</span>
                </div>
              </CardContent>
            </Card>
          ))}
        ...
        <p className="mt-8 text-center text-sm text-gray-500">
          ...
          <a href="/support" className="font-medium text-[#954DEA] hover:text-[#8A45D8]">
            support team
          </a>
          .
        </p>
